        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Transforming brands through strategic social media marketing and proven growth tactics.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <p>+1 (234) 567-8900</p>
              <p>hello@socialproconsulting.com</p>
            </div>
            <button
              onClick={() => {
                const message = encodeURIComponent("Hi! I found your website and I'm interested in your social media consulting services. Can we chat?");
                window.open(`https://wa.me/1234567890?text=${message}`, '_blank');
              }}
              className="mt-4 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors inline-flex items-center"
            >
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 SocialPro Consulting. All rights reserved.
            </p>
